...
data class MainUiState(
    ...
    val messageServiceRunning: Boolean = false,
    val messagePendingCount: Int = 0,
    val latestMessageTitle: String = "",
    val latestMessageReceivedAt: String = "",
    val lastMessageError: String = "",
